...
// bestCustomer in global scope and assigns it to be 'not bob'. (Poor Bob.) Also,
// poor us, declaring a global variable from inside a function is one of those
...
// scope, by writing a new function called overwriteBestCustomer() that changes that
// bestCustomer variable.
function overwriteBestCustomer() {
    bestCustomer = 'maybe bob';
}

// leastFavoriteCustomer and changeLeastFavoriteCustomer(): Now declare a constant
// (using the const keyword) in global scope called leastFavoriteCustomer;
